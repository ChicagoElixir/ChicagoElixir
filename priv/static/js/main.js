jQuery(document).ready(function($) {
  ...
  owl.owlCarousel({
    itemsCustom: [[0, 1], [450, 1], [600, 2], [700, 3], [1000, 3], [1200, 3]],
    pagination: false,
    navigation: true,
    navigationText: [
      '<i class="pe-4x pe-7s-angle-left pe-border"></i>',
  ...
  var latlng = new google.maps.LatLng(41.8853836, -87.6473097);
  ...
  var marker1 = new google.maps.Marker({
    position: new google.maps.LatLng(41.8853836, -87.6473097),
    map: map,
  ...
  var infowindow1 = new google.maps.InfoWindow({
    content: createInfo(
      'Hashrocket',
      '661 W Lake St, Floor 3NE,<br />Chicago, IL, 60661,<br />1-887-885-8846<br /><br />'
    ),
  });
  ...
  function createInfo(title, content) {
    return (
      '<div class="infowindow"><h4>' + title + '</h4>' + content + '</div>'
    );
  }
});
